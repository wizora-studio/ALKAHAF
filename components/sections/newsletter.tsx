            ...
            <div className="flex flex-col gap-4">
              <form onSubmit={handleSubmit} className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 sm:pr-32 py-4 rounded-2xl bg-white border border-[#EAE3D6] text-[#2D1C13] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#C5A059]/50 focus:border-[#C5A059] transition-all shadow-sm"
                  aria-label={newsletterDict.placeholder}
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="mt-4 sm:mt-0 sm:absolute sm:right-2 sm:top-2 sm:bottom-2 px-6 rounded-xl bg-[#C5A059] text-white font-bold hover:bg-[#B38F46] transition-all duration-300 shadow-md disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  aria-label={
